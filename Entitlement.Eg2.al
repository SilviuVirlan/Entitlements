...
entitlement BC_Custom
{
    Type = FlatRateServicePlan;
    Id = '...';
    ObjectEntitlements = "MyOfferLicensePermission";
}
codeunit 50100 AccessCheckChecker
{
...
codeunit 50101 InherentPermCodeunit
{
    [InherentPermissions(PermissionObjectType::TableData, Database::MyTable, 'R', InherentPermissionsScope::Both)]
    // OR
    //[InherentPermissions(PermissionObjectType::TableData,Database::MyTable, 'R', InherentPermissionsScope::Permissions)]
    local procedure InsertInMyTable()
    var
        myInt: Integer;
    begin
